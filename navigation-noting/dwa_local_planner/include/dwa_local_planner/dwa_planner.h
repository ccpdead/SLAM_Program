...
namespace dwa_local_planner {
  ...
  class DWAPlanner {
    ...
    private:
      ...
      /**
       * @brief dwa_local_planner 中定义了七个打分器,最路径进行打分。
       * 
       */
      base_local_planner::SimpleTrajectoryGenerator generator_;
      
      base_local_planner::OscillationCostFunction oscillation_costs_;//￥运动打分判断，是否震荡，是：代价大
      base_local_planner::ObstacleCostFunction obstacle_costs_;//￥障碍物碰撞打分，碰到障碍物 代价值增大
      base_local_planner::MapGridCostFunction path_costs_;//￥局部轨迹（根据当前速度外推的轨迹）与局部路径（规划的路径）对比，局部轨迹离局部路径横向偏差小，代价就小
      base_local_planner::MapGridCostFunction goal_costs_;//￥局部轨迹与局部路径的终点进行对比，希望距离小
      base_local_planner::MapGridCostFunction goal_front_costs_;//￥局部轨迹与局部路径的最终点的朝向一致
      base_local_planner::MapGridCostFunction alignment_costs_;
      base_local_planner::TwirlingCostFunction twirling_costs_;//￥机器人旋转不要太大
