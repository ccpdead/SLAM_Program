...
namespace dwa_local_planner {
  ...
  /**
   * @brief 通过base_local_planner中的SimpleTrajectoryGenerator类的intialise（）函数，产生采样速度
   * @brief 得到速度采样空间，以及SimpleScoredSamplingPlanner中的findBestTrajectory（）函数，通过打分函数生成最有路径。
   * 
   * @param global_pose 
   * @param global_vel 
